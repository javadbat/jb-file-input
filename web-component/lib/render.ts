    ...
    <section class="upload-section" role="status" aria-live="polite" aria-label="${dictionary.get(i18n, "uploading")}">
      <slot name="upload">
        <div class="upload-wrapper">
          ...
          <div class="progress-top-level" part="progress-top-level"></div>
        </div>
      </slot>
    </section>
    ...
    <slot name= "overlay">
      <div class="file-overlay">
        <slot name="overlay-content">
          ...
          <jb-button class="download-button" color="light" variant="ghost" aria-label="${dictionary.get(i18n, "downloadFile")}" square>
          ...
          <jb-button class="delete-button" color="danger" variant="ghost" size="md" aria-label="${dictionary.get(i18n, "deleteFile")}" square>
            <jb-icon-delete color="danger" class="icon" size="md"></jb-icon-delete>
          </jb-button>
        </slot>
      </div>
    </slot>
